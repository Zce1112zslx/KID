...
def masked_softmax(logits, mask):
    # input: logits [..., max_len] mask: [..., max_len] 0/1 tensor 
    # output: softmax over logits with mask
    ...
    masked_exps = exps * mask.float() + 1E-6
    masked_sums = torch.sum(masked_exps, dim=-1, keepdim=True)
    # zeros = (masked_sums == 0)
